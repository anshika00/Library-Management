...
public static void login() {
    ...
    login_but.addActionListener(new ActionListener() {  //Perform action
        ...
        var username = F_user.getText(); //Store username entered by the user in the variable "username"
        @SuppressWarnings("deprecation")
		var password = F_pass.getText(); //Store password entered by the user in the variable "password"
